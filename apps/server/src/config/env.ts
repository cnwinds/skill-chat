...
const envSchema = z.object({
  ...
  WEB_SEARCH_PROVIDERS: z.string().optional().default(''),
  ...
  IMAGE_PROVIDERS: z.string().optional().default(''),
  OPENAI_IMAGE_API_KEY: z.string().optional().default(''),
  OPENAI_IMAGE_BASE_URL: z.string().url().default('https://api.openai.com/v1'),
  OPENAI_IMAGE_MODEL: z.string().default('gpt-image-2'),
  ZHIPU_IMAGE_API_KEY: z.string().optional().default(''),
  ZHIPU_IMAGE_BASE_URL: z.string().url().default('https://open.bigmodel.cn/api/paas/v4'),
  ZHIPU_IMAGE_MODEL: z.string().default('glm-image'),
  DASHSCOPE_IMAGE_API_KEY: z.string().optional().default(''),
  DASHSCOPE_IMAGE_BASE_URL: z.string().url().default('https://dashscope.aliyuncs.com'),
  DASHSCOPE_IMAGE_MODEL: z.string().default('wan2.1-t2i-turbo'),
